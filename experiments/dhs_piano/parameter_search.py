...
if __name__ == '__main__':
    ...
    # Construct paths
    trial_directory = os.path.join(RESULTS_PATH, 'dhs_piano_parameter_trials')
    model_directory = os.path.join(RESULTS_PATH, 'dhs_piano_model')
    data_directory = os.path.join(RESULTS_PATH, 'training_dataset_piano_roll')
