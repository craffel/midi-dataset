...
if __name__ == '__main__':
    ...
    # Delete variables which are no longer used to conserve memory
    del msd_index
    del midi_index
    del msd_list
    del midi_list
    del midi_msd_mapping

    # Run match_one_midi for each MIDI data and MSD index list
    results = joblib.Parallel(n_jobs=8, verbose=51)(
    ...
    output_path = os.path.join(RESULTS_PATH, 'dhs_piano_match_results')
